...
const Peugeot5008Info: FC<Props> = (props): JSX.Element => {
  return (
    <table className="w-full">
      <tbody>
        <tr>
          ...
          <td width="280">
            <strong>New 5008 AL</strong>
          </td>
          <td width="280">
            <strong>New 5008 GT</strong>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="280">4.670 x 1.855 x 1.655</td>
          <td width="280">4.670 x 1.855 x 1.655</td>
        </tr>
        <tr>
          <td colSpan={2} width="530" height="20">
        ...
        <tr>
          <td rowSpan={3} width="530" height="20">
            Mức tiêu thụ nhiên liệu / Fuel consumption (L/100 km)
          </td>
          <td width="530" height="20">
            Kết hợp / Combination
          </td>
          <td width="280">6,87</td>
          <td width="280">8,69</td>
        </tr>
        <tr>
          <td width="530" height="20">
            Trong đô thị / Urban
          </td>
          <td width="280">9,25</td>
          <td width="280">11,52</td>
        </tr>
        <tr>
          <td width="530" height="20">
        ...
        <tr>
          <td rowSpan={2} width="149" height="78">
        ...
        <tr>
          ...
          <td width="280">
            Mâm hợp kim 18-inch kiểu Detroit / Detroit design 18-inch Alloy
            wheels
          </td>
          <td width="280">
        ...
        <tr>
          <td rowSpan={6} width="149" height="137">
        ...
        <tr>
          <td rowSpan={4} width="149" height="80">
        ...
        <tr>
          <td colSpan={2} width="530" height="20">
            Điều chỉnh ghế phụ từ hàng ghế 2 / Passenger seat controlled by 2nd
            row
          </td>
          <td width="280"></td>
          <td width="280"></td>
        ...
        <tr>
          <td colSpan={2} width="530" height="19">
            ...
            <span>&nbsp;row: 50:50 folding &amp; removable</span>
          </td>
          <td width="280">●</td>
          <td width="280">●</td>
        </tr>
...
export default Peugeot5008Info;
