...
const buttonClasses =
  "w-full flex items-center gap-1 bg-red-700 text-white rounded-lg text-center py-2 justify-center hover:bg-red-800";
...
const CarCard: FC<Props> = ({ car }): JSX.Element => {
  return (
    <Link
      ...
      className="shadow-md rounded-lg border border-[#eee] p-4 pb-10 hover:scale-[1.01] hover:shadow-lg transition duration-500"
    >
